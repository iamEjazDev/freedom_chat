import 'package:chat_app/views/audio_call_page/audio_call_page.dart';
import 'package:chat_app/views/profile_page/profile_page.dart';
import 'package:chat_app/views/video_call_page/video_call_page.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const AudioCallingPage()));
            },
          ),
          IconButton(
            icon: const Icon(Icons.videocam),
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const VideoCallingPage()));
            },
          ),
